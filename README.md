...
```bash
# Clone Sources
git clone https://github.com/fmenesesg/rhoar-homework.git
...
export HW_PRJ=homework-rhoar-temporal
...
FREELANCER SERVICE (spring boot) INSTALL AND DEPLOY
```bash
# Go to Freelancer service path:
cd freelancer-service/

# Install postgress DB for freelancer service:
...
# Generate variable for routing to Freelancer Service:
...
# Generate variable for routing to Project Service:
...
# Configure endpoint URL for gateway service: 
